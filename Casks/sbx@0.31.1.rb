cask "sbx@0.31.1" do
  version "0.31.1"
  sha256 "c6bce4522addffa4003c513b003e8b4052f5a451923f4530252a812f9cfc51d1"
  ...
  binary "bin/sbx", target: "sbx-0.31.1"
  bash_completion "completions/bash/sbx", target: "sbx-0.31.1"
  fish_completion "completions/fish/sbx.fish", target: "sbx-0.31.1.fish"
  zsh_completion "completions/zsh/_sbx", target: "_sbx-0.31.1"
