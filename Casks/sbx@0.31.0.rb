cask "sbx@0.31.0" do
  version "0.31.0"
  sha256 "8ed0807f8e7f4ecfe11bad8b0f59768971800456423a04ba1ac99ff498900496"
  ...
  binary "bin/sbx", target: "sbx-0.31.0"
  bash_completion "completions/bash/sbx", target: "sbx-0.31.0"
  fish_completion "completions/fish/sbx.fish", target: "sbx-0.31.0.fish"
  zsh_completion "completions/zsh/_sbx", target: "_sbx-0.31.0"
