cask "sbx@0.43.0" do
  ...
  binary "bin/sbx", target: "sbx-0.43.0"
  bash_completion "completions/bash/sbx", target: "sbx-0.43.0"
  fish_completion "completions/fish/sbx.fish", target: "sbx-0.43.0.fish"
  zsh_completion "completions/zsh/_sbx", target: "_sbx-0.43.0"
