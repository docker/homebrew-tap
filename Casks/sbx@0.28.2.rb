cask "sbx@0.28.2" do
  version "0.28.2"
  sha256 "b6abb69ff29d1ee57d5ad463daa0d4262e15ead9ff8b920361c97b2ef9e7f33c"
  ...
  binary "bin/sbx", target: "sbx-0.28.2"
  bash_completion "completions/bash/sbx", target: "sbx-0.28.2"
  fish_completion "completions/fish/sbx.fish", target: "sbx-0.28.2.fish"
  zsh_completion "completions/zsh/_sbx", target: "_sbx-0.28.2"
